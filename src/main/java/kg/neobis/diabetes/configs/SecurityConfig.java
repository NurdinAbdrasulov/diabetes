package kg.neobis.diabetes.configs;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .cors()
                    .and()
                .authorizeRequests()
                    .antMatchers("/login", "/registration/step1", "/registration/step2", "/registration/getGenders", "/registration/getDiabetesStatuses", "/user/forget", "/user/reset", "/group/getAllActiveGroups").permitAll()
